...
typedef enum {
  ...
  Up,         ///< Rotate figure clockwise.
  Down,       ///< Move figure down.
  Action      ///< Additional action, context-specific.
} UserAction_t;
 ...
 */
typedef enum {
  START,      ///< Game is at the start screen.
  SPAWN,      ///< A new figure is spawning.
  MOVING,     ///< Figure is in motion.
  SHIFTING,   ///< Figure is being shifted or rotated.
  ATTACHING,  ///< Figure is attaching to the stack.
